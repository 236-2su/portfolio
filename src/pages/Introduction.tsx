...
export default function Introduction() {
  const profile = {
    ...
    bio: '3년간의 관세사 시험 준비를 통해 법전을 파고들던 집요한 끈기는 이제 저의 가장 강력한 개발 무기가 되었습니다. 단순히 코드를 짜는 것을 넘어, AI 기술이 사용자에게 닿는 \'서비스\'로 완성될 때까지 끊임없이 고민합니다. 스마트팜 안전 시스템부터 개인화 추천 서비스까지, 마주하는 기술적 난제들을 끝까지 해결해내는 과정에서 엔지니어로서의 가치를 증명해왔습니다',
  };
